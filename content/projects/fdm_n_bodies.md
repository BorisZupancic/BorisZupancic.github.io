...
I used this tool to generate data both for my [B.Sc. thesis report]({{% ref "research/undergraduate_thesis.md" %}}) and eventual paper, [*Fuzzy Dark Matter and the Quasi-Particle Hypothesis*](https://doi.org/10.1093/mnras/stad3620), published with my undergraduate advisor Larry Widrow.

*To-Do*:
1. *Insert a visual of the simulations*
2. *Add description of how to run a simulation.*
